...
reinstall() {
  local workspace
  workspace="~/setup/networking-workspace"
...
function good_morning(){
  ...
  pull_if_no_dirty_changes "${HOME}/workspace/routing-api-cli"
  ...
  pull_if_no_dirty_changes "${HOME}/workspace/routing-perf-release"
  ...
  pull_if_no_dirty_changes "${HOME}/workspace/routing-release"
  ...
  pull_if_no_dirty_changes "${HOME}/workspace/istio-scaling"

  # Community Bot: an ever changing tool to help with our community responsibilities
  pull_if_no_dirty_changes "${HOME}/workspace/community-bot"
  ...
  pull_if_no_dirty_changes "${HOME}/workspace/silk"
  ...
  pull_if_no_dirty_changes "${HOME}/workspace/pks-networking-env-metadata"

  # PKS Networking Env Metadata-- env info for pivotal ci
  pull_if_no_dirty_changes "${HOME}/workspace/norsk-config"
}
...
all_the_repos() {
  ...
  # Community Bot: an ever changing tool to help with our community responsibilities
  clone_if_not_exist "https://github.com/cf-routing/community-bot" "${HOME}/workspace/community-bot"
  ...
  # PKS Networking Env Metadata -- env info for pivotal ci
  clone_if_not_exist "git@github.com:pivotal/pks-networking-env-metadata" "${HOME}/workspace/pks-networking-env-metadata"
...
function ws(){
  ...
  tmux new-session -A -s $sesh "tmux source-file ~/setup/networking-workspace/tmux_workspaces/${sesh}"
}
...
source $HOME/setup/networking-workspace/custom-commands.sh
